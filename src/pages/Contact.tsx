  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "byrumadhusudhan@gmail.com",
      link: "mailto:byrumadhusudhan@gmail.com",
    },
    {
      icon: <Phone className="w-5 h-5" />,
      label: "Phone",
      value: "+1 573-465-5032",
      link: "tel:+1 573-465-5032",
    },
    {
      icon: <MapPin className="w-5 h-5" />,
      label: "Location",
      value: "Lousville, KY, USA",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      label: "LinkedIn",
      link: "https://linkedin.com/in/madhusudhanbyru37",
    },
    {
      icon: <MessageCircle className="w-5 h-5" />,
      label: "WhatsApp",
      link: "https://wa.me/+15734655032",
    },
  ];
